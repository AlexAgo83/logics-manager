...
flowchart LR
    Request[req_056_add_codex_context_pack_attention_e] --> Problem[The plugin can already inject an]
    Problem --> Scope[Build Codex context pack for related]
    Scope --> Acceptance[AC1: The plugin can assemble a]
