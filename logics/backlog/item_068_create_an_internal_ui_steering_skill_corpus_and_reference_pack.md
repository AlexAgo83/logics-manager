...
flowchart LR
    Request[req_057_add_an_internal_ui_steering_skill_] --> Problem[The repository needs a dedicated internal]
    Problem --> Scope[Create an internal UI steering skill]
    Scope --> Acceptance[AC1: A new internal skill exists]
