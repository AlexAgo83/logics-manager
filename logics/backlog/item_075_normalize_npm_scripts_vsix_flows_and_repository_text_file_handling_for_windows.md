## item_075_normalize_npm_scripts_vsix_flows_and_repository_text_file_handling_for_windows - Normalize npm scripts VSIX flows and repository text-file handling for Windows
> From version: 1.10.8
> Status: Done
> Understanding: 96%
> Confidence: 93%
...
- Primary task(s): `task_077_normalize_npm_scripts_vsix_flows_and_repository_text_file_handling_for_windows`
...
# Priority
- Impact: High. This item removes cross-platform breakpoints in the project commands that maintainers and users are expected to run directly.
- Urgency: High. The current scripts still contain known Windows breakpoints such as `/tmp`, `python3`, and shell substitution.
...
- Completed via `task_077_normalize_npm_scripts_vsix_flows_and_repository_text_file_handling_for_windows`.
