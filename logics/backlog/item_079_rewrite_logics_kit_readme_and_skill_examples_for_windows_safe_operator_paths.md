...
- Primary task(s): `task_084_rewrite_logics_kit_readme_and_skill_examples_for_windows_safe_operator_paths`
...
# Priority
- Impact: High. The kit README and skill examples define the operator contract across repos, not just in this extension.
- Urgency: Medium. This should land as soon as the supported command surface is stable enough to document precisely.
