...
# Priority
- Impact: Medium. A real Windows VM path catches issues that CI and static review will miss.
- Urgency: Medium. It becomes most useful once the first Windows CI lane exists and manual smoke scope can be kept focused.
