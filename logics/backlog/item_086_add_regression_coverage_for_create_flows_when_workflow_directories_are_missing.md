...
# Priority
- Impact: Medium. This protects create flows against a real partial-bootstrap regression class with low implementation cost.
- Urgency: High. The behavior already exists today and should be locked down quickly with targeted tests.
