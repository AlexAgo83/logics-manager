## item_123_introduce_workflow_doc_schema_versioning_and_named_migration_commands - Introduce workflow doc schema versioning and named migration commands
> From version: 1.11.1
> Status: Done
> Understanding: 97%
> Confidence: 95%
...
- Architecture follow-up: Capture an ADR only if schema-versioning and named migration semantics become a long-lived compatibility contract.
