...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|strengthen-bulk-mutation-safety-with-tra|req-082-strengthen-logics-kit-primitives|make-the-logics-kit-easier-to|ac1-the-kit-supports-a-repo-native
flowchart LR
