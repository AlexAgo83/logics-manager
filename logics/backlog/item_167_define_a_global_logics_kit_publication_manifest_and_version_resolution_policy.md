...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-a-global-logics-kit-publication-|req-099-replace-repo-local-codex-overla|the-global-runtime-only-works-if|ac1-a-global-publication-manifest
flowchart LR
