...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|add-plugin-in-progress-feedback-for-olla|req-095-adapt-the-vs-code-logics-plugin-|give-the-operator-immediate-visible-feed|ac1-when-a-plugin-tool-action
flowchart LR
