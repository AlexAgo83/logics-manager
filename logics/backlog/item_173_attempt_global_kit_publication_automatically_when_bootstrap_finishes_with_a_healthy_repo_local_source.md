...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|attempt-global-kit-publication-automatic|req-101-make-logics-bootstrap-converge-t|ensure-the-logics-bootstrap-flow-is|ac1-when-bootstrap-runs-on-a
flowchart LR
