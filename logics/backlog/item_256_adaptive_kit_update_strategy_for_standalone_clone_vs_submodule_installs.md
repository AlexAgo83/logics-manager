...
flowchart LR
    Request[req_133_add_kit_update_fallback_when_logic] --> Problem[After a fallback install item_255 logics]
    Problem --> Scope[Adaptive kit update strategy for standalon]
    Scope --> Acceptance[AC1: The plugin detects whether logics]
