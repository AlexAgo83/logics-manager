...
- ```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|fix-ac-traceability-gaps-in-task-126-and|req-158-address-post-audit-improvements-|fix-ac-traceability-gaps-the-10|ac1-ac-traceability-proof-lines-are
flowchart TD
    Request[req_158_address_post_audit_improvements_ac] --> Problem[Fix AC traceability gaps: the 10]
    Problem --> Scope[Fix AC traceability gaps in task_126]
...
- Keywords: fix, traceability, gaps, task_126, and, suppress, spurious, adr
- Use when: Use when implementing or reviewing the delivery slice for Fix AC traceability gaps in task_126 and suppress spurious ADR signals on Low complexity backlog items.
