...
flowchart TD
    A[Fix AC traceability gaps] --> B[Suppress spurious ADR suggestions]
    B --> C[Generate logics/INDEX.md]
    C --> D[Generate logics/RELATIONSHIPS.md]
    D --> E[Plan modularization of largest files]
    E --> F[Audit categories: hygiene, navigation, risk]
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|generate-index-md-and-relationships-md-f|req-158-address-post-audit-improvements-|fix-ac-traceability-gaps-the-10|ac1-ac-traceability-proof-lines-are
flowchart TD
...
- Keywords: generate, index, and, relationships, for, the, logics, doc
- Use when: Use when implementing or reviewing the delivery slice for Generate INDEX.md and RELATIONSHIPS.md for the Logics doc corpus.
