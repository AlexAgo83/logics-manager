...
- In:
  ...
  - Make the repair write a line that satisfies the check it was recommended by.
...
- AC2: Running the recommended repair clears the finding it was recommended by.
...
# AC Traceability
- request-AC1 -> This backlog slice. Proof: AC1: The finding states the expected form, including the target, the keyword, and one line per criterion.
- request-AC2 -> This backlog slice. Proof: AC2: Running the recommended repair clears the finding it was recommended by.
- request-AC3 -> This backlog slice. Proof: AC3: A freshly scaffolded corpus satisfies the closeout gate with no hand editing.
- request-AC8 -> This backlog slice. Proof: AC4: The placeholder is recognisable as unfilled without restating the criterion.
