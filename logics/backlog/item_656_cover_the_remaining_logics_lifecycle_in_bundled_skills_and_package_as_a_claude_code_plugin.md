## item_656_cover_the_remaining_logics_lifecycle_in_bundled_skills_and_package_as_a_claude_code_plugin - Re-sync installed skills on self-update, and detect Hermes and Antigravity as additional harnesses
> From version: 2.21.1
> Schema version: 1.0
> Status: Ready
> Understanding: 90%
...
# AI Context
- Summary: Re-sync installed skills on self-update, and detect Hermes and Antigravity as additional harnesses
- Keywords: backlog-groom, request, skills install, drift, self-update, auto-sync, hermes, antigravity, ollama, agentskills
- Use when: Use when implementing or reviewing skill-install drift detection, the self-update hook, or Hermes/Antigravity harness support.
