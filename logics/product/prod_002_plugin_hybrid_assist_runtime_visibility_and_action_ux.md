...
> Related backlog: `item_155_extend_plugin_environment_diagnostics_with_hybrid_runtime_health_backend_selection_and_degraded_state_visibility`
...
> Related architecture: `adr_012_keep_the_vs_code_plugin_as_a_thin_client_over_shared_hybrid_runtime_commands`
...
- how shared hybrid runtime concepts differ from Codex-specific overlay affordances.
...
- Keep the plugin understandable by separating shared runtime concepts from Codex-specific overlay actions.
...
- Hybrid runtime concepts should be named separately from Codex overlay concepts.
