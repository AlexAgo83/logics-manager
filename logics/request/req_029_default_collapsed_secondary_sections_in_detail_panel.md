...
flowchart TD
  ...
  Indicators[Indicators (expanded)]
  Companion[Companion docs (collapsed)]
  Specs[Specs (collapsed)]
  References[References (collapsed)]
  UsedBy[Used by (collapsed)]
  Actions[Main Actions]
  Header --> Indicators
  Indicators --> Companion
  Companion --> Specs
  Specs --> References
  References --> UsedBy
  UsedBy --> Actions
