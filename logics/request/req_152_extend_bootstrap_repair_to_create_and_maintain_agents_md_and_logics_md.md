...
# Clarifications
- The canonical `LOGICS.md` template embedded in the kit must be **minimal**: workflow stages, CLI commands, kit repair steps. Extended content (UI steering, RTK, code-review-graph) belongs in the repo-local file and must not be generated by bootstrap — it is too project-specific to ship as a generic template.
- Scope is strictly `AGENTS.md` + `LOGICS.md`. Managing other AI config files (`CLAUDE.md`, `GEMINI.md`, `CODE_REVIEW_GRAPH.md`, `RTK.md`, etc.) is out of scope for this request — open a dedicated request if needed.

# AC Traceability
- AC1 -> Task `task_126_orchestration_delivery_for_req_150_to_req_154_plugin_polish_and_status_selector` and backlog item `item_278_extend_bootstrap_repair_to_create_and_maintain_agents_md_and_logics_md`. Proof: implemented in task_126 wave 4 and closed by the task finish flow on 2026-04-11.
- AC2 -> Task `task_126_orchestration_delivery_for_req_150_to_req_154_plugin_polish_and_status_selector` and backlog item `item_278_extend_bootstrap_repair_to_create_and_maintain_agents_md_and_logics_md`. Proof: implemented in task_126 wave 4 and closed by the task finish flow on 2026-04-11.
- AC3 -> Task `task_126_orchestration_delivery_for_req_150_to_req_154_plugin_polish_and_status_selector` and backlog item `item_278_extend_bootstrap_repair_to_create_and_maintain_agents_md_and_logics_md`. Proof: implemented in task_126 wave 4 and closed by the task finish flow on 2026-04-11.
- AC4 -> Task `task_126_orchestration_delivery_for_req_150_to_req_154_plugin_polish_and_status_selector` and backlog item `item_278_extend_bootstrap_repair_to_create_and_maintain_agents_md_and_logics_md`. Proof: implemented in task_126 wave 4 and closed by the task finish flow on 2026-04-11.
- AC5 -> Task `task_126_orchestration_delivery_for_req_150_to_req_154_plugin_polish_and_status_selector` and backlog item `item_278_extend_bootstrap_repair_to_create_and_maintain_agents_md_and_logics_md`. Proof: implemented in task_126 wave 4 and closed by the task finish flow on 2026-04-11.
- AC6 -> Task `task_126_orchestration_delivery_for_req_150_to_req_154_plugin_polish_and_status_selector` and backlog item `item_278_extend_bootstrap_repair_to_create_and_maintain_agents_md_and_logics_md`. Proof: implemented in task_126 wave 4 and closed by the task finish flow on 2026-04-11.
- AC7 -> Task `task_126_orchestration_delivery_for_req_150_to_req_154_plugin_polish_and_status_selector` and backlog item `item_278_extend_bootstrap_repair_to_create_and_maintain_agents_md_and_logics_md`. Proof: implemented in task_126 wave 4 and closed by the task finish flow on 2026-04-11.
