...
# Plan
- [ ] 1. Inspect flow manager changes (scripts, CLI usage, templates, placeholders) and note required updates.
- [ ] 2. Review extension invocations for New Request and Promote flows; update commands/args to match.
- [ ] 3. Update script-path checks and error messaging if names/locations changed.
- [ ] 4. Confirm placeholders/indicators handling is intentional (prefill vs leave templates).
