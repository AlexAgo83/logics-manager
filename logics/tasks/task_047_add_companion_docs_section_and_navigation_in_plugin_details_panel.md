...
```mermaid
%% logics-kind: task
%% logics-signature: task|add-companion-docs-section-and-navigatio|item-025-add-companion-docs-section-and-|1-add-companion-doc-navigation-sections-|npm-run-compile
flowchart LR
    Backlog[item_025_add_companion_docs_section_and_na] --> Step1[1. Add companion-doc navigation sections t]
    Step1 --> Step2[2. Surface primary-flow linkage for suppor]
    Step2 --> Step3[3. Keep direct open read actions]
