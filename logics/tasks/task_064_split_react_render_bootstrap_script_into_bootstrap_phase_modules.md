...
```mermaid
%% logics-kind: task
%% logics-signature: task|split-react-render-bootstrap-script-into|item-059-split-react-render-bootstrap-sc|1-keep-a-clear-bootstrap-cli|pytest
flowchart LR
    Backlog[item_059_split_react_render_bootstrap_scri] --> Step1[1. Keep a clear bootstrap CLI]
    Step1 --> Step2[2. Extract modules for intake config]
    Step2 --> Step3[3. Preserve generated-output semantics and]
