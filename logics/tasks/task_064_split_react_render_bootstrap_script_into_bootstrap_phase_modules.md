...
# Plan
- [ ] 1. Keep a clear bootstrap/CLI entrypoint for the script.
- [ ] 2. Extract modules for intake/config, generation planning, writing, validation, and reporting as appropriate.
- [ ] 3. Preserve generated-output semantics and current user-facing flow.
- [ ] 4. Keep the resulting structure pragmatic and discoverable.
