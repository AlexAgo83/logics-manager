...
# Context
Derived from `logics/backlog/item_074_harden_windows_support_for_extension_workflow_actions_and_runtime_detection.md`.
...
flowchart LR
    ...
    Step1 --> Step2[2. Implement a shared Windows prerequisite]
    Step2 --> Step3[3. Add or extend extension-host tests]
