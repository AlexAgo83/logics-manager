...
- Linked backlog item(s): `item_389_fix_bottom_details_panel_width_in_narrow_breakdown_layout`
- Related request(s): `req_223_fix_bottom_details_panel_width_in_narrow_breakdown_layout`
