...
# Plan
- [ ] 1. Review the generated request, product brief, backlog slices, and context-pack handoff.
- [ ] 2. Prioritize the security/audit gate slices before lower-risk maintainability work.
- [ ] 3. Implement or split the dependency and CI-gate fixes first.
- [ ] 4. Plan viewer modularization and coverage work as incremental follow-up tasks.
- [ ] 5. Run validation: Logics lint/audit, npm lint/test/coverage, Python tests, package validation, viewer smoke, and npm audit policy.
