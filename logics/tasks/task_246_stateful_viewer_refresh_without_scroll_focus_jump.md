...
- command: `npx vitest run tests/viewer.browser-host.test.ts` | result: passed | date: 2026-06-20 | note: 109 pass, no navigation regression
...
- Linked backlog item(s): `item_455_stateful_viewer_refresh_without_scroll_focus_jump`
