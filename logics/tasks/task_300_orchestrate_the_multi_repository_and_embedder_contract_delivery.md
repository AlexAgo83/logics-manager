...
# Plan
- [x] 1. Land explicit repository targeting first, since the fleet command and every embedder path depend on it.
- [x] 2. Bound the served MCP tool surface by profile and by allow and deny lists.
- [x] 3. Make the mutation preview contract uniform across every mutating tool and command.
- [x] 4. Fix self-update manager resolution, shadow refusal, and machine-readable reporting.
- [x] 5. Add document age and the stale-document health signal.
- [x] 6. Add quoting-free argument input and normalize the machine-readable envelope and exit codes.
- [x] 7. Add the fleet reporting command on top of explicit repository targeting.
- [x] 8. Bundle the delegation skills and validate the whole surface end to end.
