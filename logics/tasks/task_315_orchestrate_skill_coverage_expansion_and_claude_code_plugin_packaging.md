...
- [ ] 4. Add the .claude-plugin/plugin.json manifest last, once every skill it needs to declare exists, and verify the install check.
- [ ] 5. Run `logics-manager skills install --all-profiles` and confirm all eight skills (four existing, four new) are discovered.
- [ ] 6. Validate and index the corpus.
