...
from .help_text import (
    _build_close_help,
    _build_close_kind_help,
    _build_closeout_help,
    _build_companion_help,
    _build_companion_kind_help,
    _build_deliver_help,
    _build_finish_help,
    _build_finish_kind_help,
    _build_list_help,
    _build_new_help,
    _build_new_kind_help,
    _build_progress_help,
    _build_progress_kind_help,
    _build_promote_help,
    _build_promote_variant_help,
    _build_repair_help,
    _build_repair_kind_help,
    _build_show_help,
    _build_split_help,
    _build_split_variant_help,
    _build_start_help,
    _build_validate_closeout_help,
)
...
def validate_closeout_payload(repo_root: Path, source: str) -> dict[str, object]:
    ...
    for request_ref in sorted(request_refs):
        ...
        issues.extend(_sibling_slice_ac_issues(repo_root, request_ref, request_path, request_text, item_paths, task_path))
...
def _repair_ac_traceability_for_task(
    repo_root: Path,
    task_path: Path,
    *,
    dry_run: bool,
    ...
    """Every request this task closes out against, directly or via a linked backlog
    item, gets its AC traceability repaired -- not only the task's own primary request.
    """
...
def closeout_payload(
    ...
    *,
    ...
    _repair_ac_traceability_for_task(repo_root, task_path, dry_run=dry_run, changed_files=changed_files, steps=steps)
