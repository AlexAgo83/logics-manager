...
const allowedOversizedFiles = new Map(
  Object.entries({
    ...
    "clients/viewer/src/browser-host/index.js": { maxLines: 7600, ref: "req_273" },
    // De-monolith passes 1-2: pure helpers extracted out of index.js. May be
    // split by domain (cdx/git/dom) in later passes as they grow.
    "clients/viewer/src/browser-host/util.js": { maxLines: 1200, ref: "browser-host-split" },
    "clients/viewer/src/browser-host/render.js": { maxLines: 1900, ref: "browser-host-split" },
