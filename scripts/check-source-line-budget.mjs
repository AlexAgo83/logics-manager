...
const allowedOversizedFiles = new Map(
  Object.entries({
    ...
    // 5833: banked CDX reset endpoint (/api/cdx-reset); 5876: cdx disk payload/route.
    "logics_manager/viewer.py": { maxLines: 5876, ref: "req_273" },
    ...
    // 7405: banked CDX reset column + confirm/activate flow; 7521: CDX disk screen;
    // reclaim via the paused state.js/git/workshop split.
    "clients/viewer/src/browser-host/index.js": { maxLines: 7521, ref: "req_273" },
